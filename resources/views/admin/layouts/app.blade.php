...
<head>
	...
	<meta name="author" content="Lapis Magico">
	<meta name="keywords" content="Lapis Magico">
		...
		<nav id="sidebar" class="sidebar">
			<div class="sidebar-content js-simplebar">
				<router-link class="sidebar-brand" to="/admin/dashboard">
          			<span class="align-middle">Lapis Magico</span>
        		</router-link>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/schoolyear">
							<i class="align-middle" data-feather="square"></i> <span class="align-middle">Ano Letivo</span>
						</router-link>
					</li>
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/taxes">
							<i class="align-middle" data-feather="dollar-sign"></i> <span class="align-middle">Taxas</span>
						</router-link>
					</li>
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/registration">
							<i class="align-middle" data-feather="square"></i> <span class="align-middle">Matrícula</span>
						</router-link>
					</li>
					...
					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/hourdistances" >
							<i class="align-middle" data-feather="clock"></i> <span class="align-middle">Horas/Distancia Operação</span>
						</router-link>
					</li>

					<li class="sidebar-item">
						<router-link class="sidebar-link" to="/admin/fuel" >
							<i class="align-middle" data-feather="droplet"></i> <span class="align-middle">Combustivel</span>
						</router-link>
					</li>
						...
						<div class="dropdown-menu dropdown-menu-start dropdown-mega" aria-labelledby="megaDropdown">
							<div class="d-md-flex align-items-start justify-content-start">
								<div class="dropdown-mega-list">
									...
									<router-link to="/admin/dashboard" class="dropdown-item" >Usuários</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Áreas</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Destino de Aplicação</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Centros de Custo</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Tipos de Equipamento</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Equipamentos</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Avarias</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >Fornecedores</router-link>
									<router-link to="/admin/dashboard" class="dropdown-item" >MCSCR</router-link>
								</div>
								<div class="dropdown-mega-list">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right py-0" aria-labelledby="alertsDropdown">
								...
								<div class="list-group">
									...
									@foreach (Auth::user()->notifications->take(3) as $item)
										<router-link to="/admin/dashboard" class="list-group-item">
								...
								<div class="dropdown-menu-footer">
									<router-link to="/admin/dashboard" class="text-muted" href="#">Mostrar todas notificações</router-link>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="#" class="text-muted"><strong>Lapis Magico</strong></a> &copy; {{ date('Y')}}
							</p>
						</div>
