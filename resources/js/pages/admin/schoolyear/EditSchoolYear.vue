...
const getData = () => {
  axios.get(`/schoolyear/+${router.currentRoute.value.params.id}/edit`)
       .then((response)=>{
...
const editFunction = (values, actions) => {
  ...
  axios.patch(`/schoolyear/${retrievedData.value.id}`,values).then((response)=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Ano Letivo: {{ retrievedData.name }}</h5>
                                                    ...
                                                    <Form @submit="editFunction" :validation-schema="schema" v-slot="{ errors }">
                                                        ...
                                                        <div class="row">
                                                            <div class="mb-3 col-md-12">
                                                                ...
                                                                <Field type="text" class="form-control" :class="{'is-invalid':errors.name}" name="name" id="name" v-model="retrievedData.name" placeholder="Ano Letivo"/>
