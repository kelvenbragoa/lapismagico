...
axios.delete(`/taxes/${dataIdBeingDeleted}`)
.then(()=>{
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <!-- <router-link to="/admin/taxes/create" class="btn btn-pill btn-primary mt-3"><vue-feather type="plus"></vue-feather>Adicionar</router-link>  -->
